...
public class Parameters {
	...
	public static double mutateRate = 0.45; //0.01 OG
	// 0.01 mutation rate for mutation operator
	public static double mutateChange = 0.5; 
	// delta change for mutation operator
	// test these mutation rates also //0.075 is the best 
	//1.5 for mutatechange 
